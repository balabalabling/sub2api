...
type AccountSelectionResult struct {
	...
	// SchedulingPool records the internal OpenAI account pool that produced this
	// selection. It is intentionally kept on the service result and is not an API
	// payload field.
	SchedulingPool string
	SchedulingFallbackFromPool string
