export default {
  ...
  storefront: {
    ...
    alipayPay: 'Alipay',
    subscriptionRedirectHint: 'Subscription plans require email verification before checkout.',
    subscriptionCheckoutHint: 'After payment succeeds, a new API Key will be generated and sent to the email you entered.',
    subscriptionEmailVerifyHint: 'Subscription checkout requires email verification. If you have already verified in the query center, the cached email is used automatically.',
  ...
  payment: {
    ...
    keyDeliveryMode: 'API Key handling',
    generateNewKey: 'Generate New API Key',
    rechargeExistingKey: 'Recharge Existing API Key',
    selectApiKey: 'Select API Key',
    noMatchingApiKey: 'No API key in this plan group. Generate a new key instead.',
    ...
    admin: {
      ...
      apiKeyRechargeOrder: 'API Key Recharge',
      paidAt: 'Paid At',
      ...
      price: 'Price',
      keyQuotaUsd: 'Key Quota USD',
      keyQuotaUsdHint: '0 means unlimited; new-key purchases and existing-key recharges use this quota.',
      validityDays: 'Validity (days)',
