export default {
  ...
  payment: {
    ...
    keyDeliveryMode: 'API Key 处理方式',
    generateNewKey: '生成新 API Key',
    rechargeExistingKey: '充值已有 API Key',
    selectApiKey: '选择 API Key',
    noMatchingApiKey: '没有同分组的 API Key，可先选择生成新 Key。',
    ...
    admin: {
      ...
      apiKeyRechargeOrder: 'API Key 充值',
      paidAt: '支付时间',
      completedAt: '完成时间',
      expiresAt: '过期时间',
      feeRate: '手续费率',
      ...
      originalPrice: '原价',
      price: '价格',
      keyQuotaUsd: 'Key 额度 USD',
      keyQuotaUsdHint: '0 表示无限额度；购买新 Key 或充值已有 Key 时按此额度处理。',
      currency: '币种标注',
